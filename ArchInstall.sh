...
### SSD Encryption ###
echo -e "\n\033[1;34mEncrypting system partition\033[0m"
cryptsetup luksFormat --verify-passphrase \
  --type luks2 \
  ...
  --force-password \
  "/dev/${SSD}p2" || { 
    echo -e "\033[1;31mEncryption failed! Checking partition...\033[0m"; 
    lsblk -f "/dev/${SSD}p2";
    exit 1;
}
...
# Adding encrypted partition parameters
{
    echo -e "\n# Encrypted partition"
...
echo "1. You will be prompted for SSD decryption password at boot"
